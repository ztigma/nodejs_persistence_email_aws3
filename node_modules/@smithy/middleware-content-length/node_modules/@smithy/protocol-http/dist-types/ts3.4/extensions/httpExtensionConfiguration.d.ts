 ...
 */
export declare const getHttpHandlerExtensionConfiguration: <HandlerConfig extends object = Record<string, unknown>>(runtimeConfig: Partial<{
    httpHandler: HttpHandler<HandlerConfig>;
}>) => {
    setHttpHandler(handler: HttpHandler<HandlerConfig>): void;
    httpHandler(): HttpHandler<HandlerConfig>;
 ...
 */
export declare const resolveHttpHandlerRuntimeConfig: <HandlerConfig extends object = Record<string, unknown>>(httpHandlerExtensionConfiguration: HttpHandlerExtensionConfiguration<HandlerConfig>) => Partial<{
    httpHandler: HttpHandler<HandlerConfig>;
}>;
